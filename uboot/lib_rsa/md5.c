 ...
 */
void ssl_md5( const unsigned char *input, size_t ilen, unsigned char output[16] )
{
    md5_context ctx;
...
#if defined(POLARSSL_MD5_SELF_TEST)
/*
...
int md5_self_test( int verbose )
{
    ...
    for( i = 0; i < 7; i++ )
    {
        ...
        ssl_md5( md5_test_buf[i], md5_test_buflen[i], md5sum );
